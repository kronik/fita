...
#define kDefaultBadgeBackgroundColor AppNavigationBarSolidColor
#define kDefaultOverlayColor [UIColor colorWithWhite:1.0f alpha:0.0]

#define kDefaultBadgeTextFont [UIFont fontWithName:ApplicationBoldFont size:[UIFont systemFontSize]]
