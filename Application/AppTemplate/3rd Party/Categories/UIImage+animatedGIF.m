...
+ (NSDictionary *)imagesWithAnimatedGIFURL:(NSURL *)theURL {
    CGImageSourceRef source = CGImageSourceCreateWithURL(toCF theURL, NULL);
    ...
    if (source) {
        ...
        return @{@"images": frames, @"duration": @(totalDurationCentiseconds / 100.0)};
    } else {
        return nil;
    }
}
