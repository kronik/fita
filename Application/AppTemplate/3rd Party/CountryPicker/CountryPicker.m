...
{
    NSInteger index = [[self countryCodes] indexOfObject:countryCode];
    if (index != NSNotFound)
    {
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view
{
    ...
    NSString *fileName = [NSString stringWithFormat:@"flag-%@", [countryCode lowercaseString]];
    
    UIImage *flag = [UIImage imageNamed:fileName];
