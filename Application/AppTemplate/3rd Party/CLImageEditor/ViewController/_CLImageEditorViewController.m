...
- (void)swapToolBarWithEditting:(BOOL)editting
{
    ...
    if(self.currentTool){
        ...
        item.leftBarButtonItem  = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedStringWithDefaultValue(@"CLImageEditor_BackBtnTitle", nil, [CLImageEditorTheme bundle], NSLocalizedString(@"Back", nil), @"") style:UIBarButtonItemStylePlain target:self action:@selector(pushedCancelBtn:)];
    ...
    _navigationBar.tintColor = ApplicationMainColor;
