...
//    if (self.shareString) [self.documentController setAnnotation:@{@"InstagramCaption" : self.shareString}];
    ...
    if (self.presentFromButton) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:DMActivityInstagramDidSelectNotification object:nil];
        [self.documentController presentOpenInMenuFromRect:self.parentView.frame inView:self.parentView animated:YES];
