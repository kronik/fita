...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if (scrollView.contentOffset.y < 0) {
        ...
        if ([self.delegate respondsToSelector:@selector(gestureRecognizer:canAddRowAtIndexPath:)]) {
            BOOL canAddNewRow = [self.delegate gestureRecognizer:self canAddRowAtIndexPath:self.addingIndexPath];
